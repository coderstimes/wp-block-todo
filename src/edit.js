...
import { PanelBody, RangeControl, SelectControl, __experimentalNumberControl as NumberControl } from '@wordpress/components';
...
export default function Edit( { attributes, setAttributes } ) {
    ...
    const { columnCount, columnWidth, columnGap, columnRuleStyle,columnRuleWidth,columnRuleColor,dropCapColor,dropCapSize  } = attributes;
    ...
    return (
        <>
            <InspectorControls>
                ...
                <PanelBody title="Column Separator" initialOpen={false}></PanelBody>
                <PanelColorSettings
